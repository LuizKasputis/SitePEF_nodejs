				...
				if(fFLag1 == 0){
					...
					$('#barra').click(function(e){
						...
						if(fFLag1 == 1 && checkInput()){
							...
							$('<img src="seta.png" id="'+objeto+'" class="forca add forcaS" style="margin-left: -38px; background: transparent no-repeat; border: none ; transform: rotate('+angulo+'deg) ">').appendTo('.Sforca').animate({
									'marginLeft' : x,
							 		'marginTop' : y
  							}, 500);
				...
				if(apoioS == 0){
					...
					$('#barra').click(function(e) {
						if(apoioS == 1){
							...
							$('<img src="apoiosimples.png" id="'+objeto+'" id="forca"'+forcas+' class="forca add apoioS" style="margin-left: 185px; background: transparent no-repeat; border: none ;">').appendTo('.Sforca').animate({
							 		'marginLeft' : x - 110,
							 		'marginTop' : y
  							}, 500);
					...
					$('#barra').click(function(e) {
						if(apoioD == 1){
							...
							var y = 170;
							 ...
							 $('<img src="apoioDuplo.png" id="'+objeto+'" class="forca add apoioD" id="forca"'+forcas+' style=" margin-left: 240px; background: transparent no-repeat; border: none ;">').appendTo('.Sforca').animate({
							 		'marginLeft' : x - 110 ,
							 		'marginTop' : y
 								}, 500);
